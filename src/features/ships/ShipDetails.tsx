        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="card-body bg-zinc-700 border-l-4 border-red-500">
              <div className="">
                <h2 className="card-title uppercase pb-2">{ship?.name}</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi,
                  illo recusandae architecto dicta iste atque beatae tempora,
                  quisquam dignissimos sapiente dolorum, itaque maiores commodi
                  quidem. Ea veniam quod corrupti nam.
                </p>
              </div>
              <div className="md:flex">
                ...
                <div className="md:w-1/2">
                  <p>
                    <span className="font-bold uppercase">Manufacturer: </span>
                    {ship?.manufacturer}
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="font-bold uppercase">Crew: </span>{" "}
                    {ship?.crew}
                  </p>
                </div>
              </div>
